...
from data.database.sqlite.edge_discovery import EdgeDiscoveryManager  # noqa: E402
from data.database.sqlite.users import UserManager  # noqa: E402
...
def main():
    ...
    ap.add_argument(
        "--outdir",
        type=str,
        default="data/edge_lab_outputs",
        help="Output directory (default: data/edge_lab_outputs)",
    )
    ap.add_argument(
        "--end_pos",
        type=int,
