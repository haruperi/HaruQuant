...
from data.database.sqlite.database_operations import DatabaseManager  # noqa: E402
...
def main():
    ...
    if strategy:
        print("Location: data/database/haruquant.db")
    ...
    strategy_dir = f"data/strategies/user_{user_id}/strategy_{strategy_id}"
