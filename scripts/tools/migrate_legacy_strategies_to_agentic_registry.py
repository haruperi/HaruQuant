...
from data.database.migrations.runner import apply_pending_migrations, default_migrations_dir
from data.database.repositories.governance_repository import GovernanceRepository
...
def main() -> None:
    ...
    parser.add_argument(
        "--db-path",
        default="data/database/haruquant.db",
