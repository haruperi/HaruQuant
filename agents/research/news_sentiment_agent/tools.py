"""Declared tools for the News and Sentiment Agent."""
...
ALLOWED_TOOL_NAMES = ('get_approved_news_feed', 'get_sentiment_snapshot', 'get_economic_calendar', 'save_news_sentiment_report')
