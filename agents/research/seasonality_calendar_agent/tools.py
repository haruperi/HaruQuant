"""Declared tools for the Seasonality and Calendar Agent."""
...
ALLOWED_TOOL_NAMES = ('get_session_calendar', 'get_holiday_calendar', 'calculate_seasonality_profile', 'save_seasonality_calendar_report')
