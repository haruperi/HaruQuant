...
DEFAULT_TOOL_DEFINITIONS: tuple[ToolDefinition, ...] = (
    ...
    _tool(
        ...
        domain="data",
        execution_boundary="backend.tools.data_tools",
    ...
    _tool(
        ...
        permission_required="T1_READ_ONLY",
        domain="strategy",
        execution_boundary="backend.tools.strategy_tools",
    ...
    _tool(
        ...
        permission_required="T1_READ_ONLY",
        domain="backtest",
        execution_boundary="backend.tools.backtest_tools",
    ...
    _tool(
        ...
        permission_required="T1_READ_ONLY",
        domain="analytics",
        execution_boundary="backend.tools.analytics_tools",
    ),
    _tool(
        ...
        permission_required="T1_READ_ONLY",
        domain="portfolio",
        execution_boundary="backend.tools.portfolio_tools",
    ),
    _tool(
    ...
    _tool(
        ...
        permission_required="T1_READ_ONLY",
        domain="risk",
        execution_boundary="backend.tools.risk_tools",
    ),
    # Write tools.
    _tool(
    ...
    _tool(
        ...
        permission_required="T2_WRITE",
        domain="backtest",
        execution_boundary="backend.mcp.backtest_mcp",
    ...
    _tool(
        ...
        permission_required="T2_WRITE",
        domain="optimization",
        execution_boundary="backend.mcp.optimization_mcp",
        input_schema=_schema(("strategy_id",), strategy_id="string"),
    ),
    _tool(
        ...
        permission_required="T2_WRITE",
        domain="robustness",
        execution_boundary="backend.services.optimization",
        input_schema=_schema(("strategy_id",), strategy_id="string"),
    ),
    _tool(
    ...
    _tool(
        ...
        permission_required="T2_WRITE",
        domain="reporting",
        execution_boundary="backend.tools.reporting_tools",
    ...
    _tool(
        ...
        permission_required="T2_WRITE",
        domain="execution",
        execution_boundary="backend.execution.paper_broker",
        input_schema=_schema(("strategy_id",), strategy_id="string"),
    ...
    _tool(
        ...
        domain="portfolio",
        execution_boundary="backend.services.approval",
        input_schema=_schema(("strategy_id",), strategy_id="string"),
    ...
    _tool(
        ...
        permission_required="T3_CRITICAL",
        domain="execution",
        execution_boundary="backend.contracts.trade_proposal",
    ...
    _tool(
        ...
        permission_required="T3_CRITICAL",
        domain="risk",
        execution_boundary="backend.risk.governor",
    ...
    _tool(
        ...
        permission_required="T3_CRITICAL",
        domain="execution",
        execution_boundary="backend.execution.order_router",
        input_schema=_schema(("execution_request_id",), execution_request_id="string"),
        requires_human_approval=True,
        requires_risk_governor=True,
    ),
    ...
    _tool(
        ...
        permission_required="T3_CRITICAL",
        domain="strategy",
        execution_boundary="backend.services.strategy_gov",
        input_schema=_schema(("strategy_id",), strategy_id="string"),
        requires_human_approval=True,
    ),
    _tool(
        ...
        permission_required="T3_CRITICAL",
        domain="execution",
        execution_boundary="backend.services.safety",
        requires_human_approval=True,
    ),
    _tool(
        ...
        permission_required="T3_CRITICAL",
        domain="risk",
        execution_boundary="backend.risk.kill_switch",
        requires_human_approval=True,
        requires_risk_governor=True,
    ),
)
