...
Run:
    python backend/scripts/examples/risk/08_recommendation_engine.py
"""
...
from haruquant.risk import AllocationOptimizer, HedgeOptimizer, RebalanceSuggestionEngine
