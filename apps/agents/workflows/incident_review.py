"""Workflow runner for replay-backed incident reviews."""
...
def run_incident_review(
    ...
    *,
    ...
    specialist: IncidentInvestigatorAgent,
) -> AgentResult:
    """Run the replay-backed incident review workflow."""
