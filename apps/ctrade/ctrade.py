"""
CTrade class (MT5-specific).

This module mirrors the MQL5 Standard Library CTrade interface and
...
class CTrade:
    ...
    # ---------------------------------------------------------------------
    # Class methods by groups (per MQL5 CTrade documentation)
    # ---------------------------------------------------------------------
    # Setting parameters
