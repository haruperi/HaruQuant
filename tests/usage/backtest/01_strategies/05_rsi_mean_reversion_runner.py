"""05_rsi_mean_reversion_runner.py"""
import sys
...
RSIMeanReversionStrategy = module.RSIMeanReversionStrategy
...
def main():
    logger.info("Starting 05 RSI Mean Reversion Strategy Backtest...")
    ...
    strategy = RSIMeanReversionStrategy(params={'symbol': 'EURUSD'})
    ...
    simulator = TradeSimulator(
        simulator_name="RSIMeanReversionStrategy_Backtest",
