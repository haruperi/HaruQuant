"""02_extended_breakout_runner.py"""
import sys
...
file_path = project_root / "data/strategies/edge/02_extended_breakout.py"
spec = importlib.util.spec_from_file_location(module_name, file_path)
module = importlib.util.module_from_spec(spec)
sys.modules[module_name] = module
spec.loader.exec_module(module)
ExtendedBreakoutStrategy = module.ExtendedBreakoutStrategy
...
def main():
    logger.info("Starting 02 Extended Breakout Strategy Backtest...")
    ...
    strategy = ExtendedBreakoutStrategy(params={'symbol': 'EURUSD'})
    ...
    simulator = TradeSimulator(
        simulator_name="ExtendedBreakoutStrategy_Backtest",
