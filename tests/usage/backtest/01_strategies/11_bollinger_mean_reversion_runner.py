"""11_bollinger_mean_reversion_runner.py"""
import sys
...
module_name = "11_bollinger_mean_reversion"
file_path = project_root / "data/strategies/edge/11_bollinger_mean_reversion.py"
spec = importlib.util.spec_from_file_location(module_name, file_path)
module = importlib.util.module_from_spec(spec)
sys.modules[module_name] = module
spec.loader.exec_module(module)
BollingerMeanReversionStrategy = module.BollingerMeanReversionStrategy
...
def main():
    logger.info("Starting 11 Bollinger Mean Reversion Strategy Backtest...")
    ...
    strategy = BollingerMeanReversionStrategy(params={'symbol': 'EURUSD'})
    ...
    simulator = TradeSimulator(
        simulator_name="BollingerMeanReversionStrategy_Backtest",
