...
module_name = "06_rsi_breakout"
file_path = project_root / "data/strategies/edge/06_rsi_breakout.py"
spec = importlib.util.spec_from_file_location(module_name, file_path)
module = importlib.util.module_from_spec(spec)
sys.modules[module_name] = module
spec.loader.exec_module(module)
RSIBreakoutStrategy = module.RSIBreakoutStrategy
...
def main():
    logger.info("Starting 06 RSI Breakout Strategy Backtest...")
    ...
    strategy = RSIBreakoutStrategy(params={'symbol': 'EURUSD'})
    ...
    simulator = TradeSimulator(
        simulator_name="RSIBreakoutStrategy_Backtest",
