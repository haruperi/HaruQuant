...
module_name = "03_mean_reversion"
file_path = project_root / "data/strategies/edge/03_mean_reversion.py"
spec = importlib.util.spec_from_file_location(module_name, file_path)
module = importlib.util.module_from_spec(spec)
sys.modules[module_name] = module
spec.loader.exec_module(module)
MeanReversionStrategy = module.MeanReversionStrategy
...
def main():
    logger.info("Starting 03 Mean Reversion Strategy Backtest...")
    ...
    strategy = MeanReversionStrategy(params={'symbol': 'EURUSD'})
    ...
    simulator = TradeSimulator(
        simulator_name="MeanReversionStrategy_Backtest",
