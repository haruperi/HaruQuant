"""07_close_mean_reversion_runner.py"""
import sys
...
module_name = "07_close_mean_reversion"
file_path = project_root / "data/strategies/edge/07_close_mean_reversion.py"
spec = importlib.util.spec_from_file_location(module_name, file_path)
module = importlib.util.module_from_spec(spec)
sys.modules[module_name] = module
spec.loader.exec_module(module)
CloseMeanReversionStrategy = module.CloseMeanReversionStrategy
...
def main():
    logger.info("Starting 07 Close Mean Reversion Strategy Backtest...")
    ...
    strategy = CloseMeanReversionStrategy(params={'symbol': 'EURUSD'})
    ...
    simulator = TradeSimulator(
        simulator_name="CloseMeanReversionStrategy_Backtest",
