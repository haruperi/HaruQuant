...
from backend.contracts.workflow_intent.model import WorkflowIntent, WorkflowIntentPayload


EXAMPLES_ROOT = Path(__file__).resolve().parents[3] / "backend" / "contracts" / "workflow_intent" / "examples"
