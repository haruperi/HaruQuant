...
from contracts.trade_hypothesis.model import TradeHypothesis, TradeHypothesisPayload


EXAMPLES_ROOT = Path(__file__).resolve().parents[3] / "contracts" / "trade_hypothesis" / "examples"
