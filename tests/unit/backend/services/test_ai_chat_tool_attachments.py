...
from backend_retiring.agents.chat.ai_chat.artifact_service import ChatArtifactService
from backend_retiring.agents.chat.ai_chat.page_action_planner import PageActionPlanner
...
def test_gateway_returns_attached_tool_metadata(tmp_path) -> None:
    ...
    with patch("backend_retiring.agents.chat.ai_chat.ai_gateway.create_llm_runtime", side_effect=LLMRuntimeError("disabled")):
