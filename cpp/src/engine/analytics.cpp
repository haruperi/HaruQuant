/**
FILE: src\engine\analytics.cpp

PURPOSE:
Defines analytics.cpp functionality used by the C++ runtime and bridge layers.
...
MAIN COMPONENTS:
- Primary types/functions declared or defined in analytics.cpp.
