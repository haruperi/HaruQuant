/**
FILE: include\usage\logger_usage.hpp

PURPOSE:
Defines logger_usage.hpp functionality used by the C++ runtime and bridge layers.
...
MAIN COMPONENTS:
- Primary types/functions declared or defined in logger_usage.hpp.
