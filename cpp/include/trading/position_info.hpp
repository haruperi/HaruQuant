/**
FILE: include\trading\position_info.hpp

PURPOSE:
Defines position_info.hpp functionality used by the C++ runtime and bridge layers.
...
MAIN COMPONENTS:
- Primary types/functions declared or defined in position_info.hpp.
