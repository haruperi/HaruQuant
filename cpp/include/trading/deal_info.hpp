/**
FILE: include\trading\deal_info.hpp

PURPOSE:
Defines deal_info.hpp functionality used by the C++ runtime and bridge layers.
...
MAIN COMPONENTS:
- Primary types/functions declared or defined in deal_info.hpp.
