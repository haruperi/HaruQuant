/**
FILE: include\trading\market_state.hpp

PURPOSE:
Defines market_state.hpp functionality used by the C++ runtime and bridge layers.
...
MAIN COMPONENTS:
- Primary types/functions declared or defined in market_state.hpp.
