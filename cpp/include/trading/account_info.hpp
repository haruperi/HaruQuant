/**
FILE: include\trading\account_info.hpp

PURPOSE:
Defines account_info.hpp functionality used by the C++ runtime and bridge layers.
...
MAIN COMPONENTS:
- Primary types/functions declared or defined in account_info.hpp.
