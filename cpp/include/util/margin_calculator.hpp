/**
FILE: include\util\margin_calculator.hpp

PURPOSE:
Defines margin_calculator.hpp functionality used by the C++ runtime and bridge layers.
...
MAIN COMPONENTS:
- Primary types/functions declared or defined in margin_calculator.hpp.
