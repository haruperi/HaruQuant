/**
FILE: include\util\currency_converter.hpp

PURPOSE:
Defines currency_converter.hpp functionality used by the C++ runtime and bridge layers.
...
MAIN COMPONENTS:
- Primary types/functions declared or defined in currency_converter.hpp.
