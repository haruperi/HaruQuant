/**
FILE: include\util\fixed_point.hpp

PURPOSE:
Defines fixed_point.hpp functionality used by the C++ runtime and bridge layers.
...
MAIN COMPONENTS:
- Primary types/functions declared or defined in fixed_point.hpp.
