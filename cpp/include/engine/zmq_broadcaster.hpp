/**
FILE: include\engine\zmq_broadcaster.hpp

PURPOSE:
Defines zmq_broadcaster.hpp functionality used by the C++ runtime and bridge layers.
...
MAIN COMPONENTS:
- Primary types/functions declared or defined in zmq_broadcaster.hpp.
