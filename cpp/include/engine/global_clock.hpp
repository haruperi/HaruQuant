/**
FILE: include\engine\global_clock.hpp

PURPOSE:
Defines global_clock.hpp functionality used by the C++ runtime and bridge layers.
...
MAIN COMPONENTS:
- Primary types/functions declared or defined in global_clock.hpp.
