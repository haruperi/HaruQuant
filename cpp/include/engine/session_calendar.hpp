/**
FILE: include\engine\session_calendar.hpp

PURPOSE:
Defines session_calendar.hpp functionality used by the C++ runtime and bridge layers.
...
MAIN COMPONENTS:
- Primary types/functions declared or defined in session_calendar.hpp.
