/**
FILE: include\hqt\hello.hpp

PURPOSE:
Defines hello.hpp functionality used by the C++ runtime and bridge layers.
...
MAIN COMPONENTS:
- Primary types/functions declared or defined in hello.hpp.
