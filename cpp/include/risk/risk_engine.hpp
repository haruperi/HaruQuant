/**
FILE: include\risk\risk_engine.hpp

PURPOSE:
Defines risk_engine.hpp functionality used by the C++ runtime and bridge layers.
...
MAIN COMPONENTS:
- Primary types/functions declared or defined in risk_engine.hpp.
