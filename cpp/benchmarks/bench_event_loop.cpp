/**
FILE: benchmarks\bench_event_loop.cpp

PURPOSE:
Defines bench_event_loop.cpp functionality used by the C++ runtime and bridge layers.
...
MAIN COMPONENTS:
- Primary types/functions declared or defined in bench_event_loop.cpp.
