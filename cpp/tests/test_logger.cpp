/**
FILE: tests\test_logger.cpp

PURPOSE:
Defines test_logger.cpp functionality used by the C++ runtime and bridge layers.
...
MAIN COMPONENTS:
- Primary types/functions declared or defined in test_logger.cpp.
