/**
FILE: tests\test_event_loop.cpp

PURPOSE:
Defines test_event_loop.cpp functionality used by the C++ runtime and bridge layers.
...
MAIN COMPONENTS:
- Primary types/functions declared or defined in test_event_loop.cpp.
