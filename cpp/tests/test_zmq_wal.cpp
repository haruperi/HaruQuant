/**
FILE: tests\test_zmq_wal.cpp

PURPOSE:
Defines test_zmq_wal.cpp functionality used by the C++ runtime and bridge layers.
...
MAIN COMPONENTS:
- Primary types/functions declared or defined in test_zmq_wal.cpp.
