...
from services.research.session_config import (
    EDGE_SESSION_ORDER,
...
def _to_list(values: Iterable[Any]) -> List[Optional[float]]:
        ...
        data_rows.append(
            {
                ...
                "co_win_loss": (
                    ...
                    else -1 if row.get("co_points") < 0 else 0
                ),
                "co_pct": _clean_value(
...
def run_seasonality(
    ...
    *,
    ...
    filters: Optional[SeasonalityFilters] = None,
    data_offset: int = 0,
    data_limit: int = 20,
) -> Dict[str, Any]:
    """
