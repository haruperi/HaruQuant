...
class Dashboard:
    ...
    def __init__(
        self,
        log_file: str = "reports/logs/multi_strategy/multi_strategy.log",
    ...
    def _read_state_file(self):
        ...
        if status_file.exists():
            with contextlib.suppress(Exception), open(status_file, "r") as f:
                data = json.load(f)
    ...
    def _read_log_file(self):
        ...
        with (
            ...
            open(self.log_file, "r", encoding="utf-8") as f,
        ):
            # Read last 20 lines
            lines = f.readlines()
...
def main():
    ...
    parser.add_argument(
        "--log",
        default="reports/logs/multi_strategy/multi_strategy.log",
