...
Usage:
    python -m services.execution.live.run --config config/live_trading_config.json
"""
...
Examples:
    ...
    # Multiple strategies
    python -m services.execution.live.run --config config/multi_strategy_config.json
