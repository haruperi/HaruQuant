...
_EXPORT_MODULES = {
    ...
    "CTraderBridge": "bridges",
    "ExecutionAttemptPersistenceService": "attempts",
    "MT5Bridge": "bridges",
    "OrderRouter": "order_router",
    "PaperAccountState": "brokers.paper_broker",
    "PaperBroker": "brokers.paper_broker",
    "PaperBrokerConfig": "brokers.paper_broker",
    "PaperOrderRequest": "brokers.paper_broker",
    "PaperOrderResult": "brokers.paper_broker",
    "PaperPosition": "brokers.paper_broker",
