...
from services.indicator.momentum.rsi import rsi as compute_rsi
from services.indicator.trend.ema import ema as compute_ema
from services.indicator.trend.sma import sma as compute_sma
from services.indicator.trend.wma import wma as compute_wma
from services.indicator.volatility.atr import atr as compute_atr
from services.indicator.volatility.bbands import bbands as compute_bbands
from services.indicator.volume.accumulation_distribution import (
...
class FeaturePipeline:
    ...
    def inspect_graph(self) -> Dict[str, Any]:
        ...
        return {"pipeline_version": self.pipeline_version, "nodes": nodes, "edges": edges}
