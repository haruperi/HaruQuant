...
from services.risk.core import GovernanceEngine
from services.risk.limits import CorrelationPreference
...
class AllocationPlanner:
    ...
    def lots_to_deltas(
        ...
        return {symbol: float(target.get(symbol, 0.0) - current.get(symbol, 0.0)) for symbol in keys}
