...
from services.risk.optimization import (
    AllocationOptimizer,
...
from services.risk.scoring.scorecard_engine import RiskScorecardEngine
from services.risk.portfolio.snapshot_builder import RiskSnapshotEngine
    ...
    def _build_summary(
        ...
        *,
        ...
        return {
            ...
            "marginal_risk_recommendation": None if not reduce_candidates else reduce_candidates[0],
