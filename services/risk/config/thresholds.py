...
from services.risk.domain.exceptions import RiskConfigError
from services.risk.governance.signatures import stable_hash
...
def validate_config_hash(config: dict[str, Any], expected_hash: str | None = None) -> bool:
