...
from backend_retiring.api.middleware.security import SecretRedactionMiddleware
from backend_retiring.api.router import intent_classifier
from backend_retiring.agents.intent_router import intent_router_agent
...
async def lifespan(app: FastAPI):
    ...
    from backend_retiring.api.scheduler import start_scheduler
    ...
    from backend_retiring.api.scheduler import shutdown_scheduler
