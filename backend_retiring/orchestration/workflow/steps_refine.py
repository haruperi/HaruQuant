...
def _run_agent_analysis(
    ...
    from backend_retiring.orchestration.workflow import REFINE_AGENT_INSTRUCTION
    ...
    try:
        ...
        from backend_retiring.contracts import validate_contract_payload, load_initial_schema_registry_seeds, SchemaRegistryService
