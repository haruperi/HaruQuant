...
if TYPE_CHECKING:
    from backend_retiring.agents.chat import (
...
from backend_retiring.agents.chat.ai_chat.models import ConversationPlan, ConversationState, SpecialistAgentArtifact
    ...
    def __init__(
        ...
        *,
        ...
        if trading_advisor_agent is None:
            from backend_retiring.agents.chat.trading_advisor_agent import TradingAdvisorAgent
        ...
        if market_regime_agent is None:
            from backend_retiring.agents.chat.market_regime_agent import MarketRegimeAgent
    ...
    def consult(
        ...
        *,
        ...
        if plan.task_class == "strategy_creation":
            # Strategy creation is owned by backend_retiring.agents.strategy_creator_agent.StrategyCreatorAgent.
