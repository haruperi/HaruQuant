        ...
        return PageContextPacket(
            ...
            payload=PageContextPayload(
                ...
                authority=ContextAuthority(
                    source=f"backend_retiring.agents.chat.ai_chat.context_service:{builder_name}",
        ...
        *,
        ...
        return PageContextPacket(
            ...
            payload=PageContextPayload(
                ...
                freshness=ContextFreshness(observed_at=now, staleness_seconds=0),
                authority=ContextAuthority(
                    source=f"backend_retiring.agents.chat.ai_chat.context_service:{built.builder_name}",
