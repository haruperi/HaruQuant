...
def _register_builtin_providers() -> None:
    ...
    try:
        ...
        from backend_retiring.agents.runtime.litellm_runtime import LiteLLMRuntime
    ...
    try:
        ...
        from backend_retiring.agents.runtime.openai_runtime import OpenAIRuntime
    ...
    try:
        ...
        from backend_retiring.agents.runtime.google_adk_runtime import GoogleADKRuntime
