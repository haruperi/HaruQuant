...
existing canonical contracts from `backend_retiring.contracts` where they already exist,
...
from backend_retiring.contracts.execution_intent.model import ExecutionIntent as CanonicalExecutionIntent
from backend_retiring.contracts.execution_receipt.model import ExecutionReceipt as CanonicalExecutionReceipt
...
from backend_retiring.contracts.strategy_blueprint.model import StrategyBlueprint as CanonicalStrategyBlueprint
from backend_retiring.contracts.trade_proposal.model import TradeProposal as CanonicalTradeProposal
from backend_retiring.contracts.workflow_plan.model import StepFailurePolicy, WorkflowPlan as CanonicalWorkflowPlan
