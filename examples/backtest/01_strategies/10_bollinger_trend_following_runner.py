"""10_bollinger_trend_following_runner.py"""
import sys
...
module_name = "10_bollinger_trend_following"
file_path = project_root / "data/strategies/edge/10_bollinger_trend_following.py"
spec = importlib.util.spec_from_file_location(module_name, file_path)
module = importlib.util.module_from_spec(spec)
sys.modules[module_name] = module
spec.loader.exec_module(module)
BollingerTrendFollowingStrategy = module.BollingerTrendFollowingStrategy
...
def main():
    logger.info("Starting 10 Bollinger Trend Following Strategy Backtest...")
    ...
    strategy = BollingerTrendFollowingStrategy(params={'symbol': 'EURUSD'})
    ...
    simulator = TradeSimulator(
        simulator_name="BollingerTrendFollowingStrategy_Backtest",
