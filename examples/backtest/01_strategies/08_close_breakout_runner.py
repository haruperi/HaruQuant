...
module_name = "08_close_breakout"
file_path = project_root / "data/strategies/edge/08_close_breakout.py"
spec = importlib.util.spec_from_file_location(module_name, file_path)
module = importlib.util.module_from_spec(spec)
sys.modules[module_name] = module
spec.loader.exec_module(module)
CloseBreakoutStrategy = module.CloseBreakoutStrategy
...
def main():
    logger.info("Starting 08 Close Breakout Strategy Backtest...")
    ...
    strategy = CloseBreakoutStrategy(params={'symbol': 'EURUSD'})
    ...
    simulator = TradeSimulator(
        simulator_name="CloseBreakoutStrategy_Backtest",
